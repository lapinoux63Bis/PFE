...
#registre trans
data_attaque_trans = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\attaque1_nmap\registre_transmissions.csv",delimiter = ';', names = ["Temps","Ip_src", "Ip_dest","Port_src","Port_dest","sup1","sup2","protocole"]) #delimiter seulement pour registre_transmissions
...
data_attaque_cpuusage = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\attaque1_nmap\cpu_stats.csv", names = ["Temps","Temperature", "Frequency", "Cpu_usage", "Cpu_memory"])
...
data_attaque_fcpu1 = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\attaque1_nmap\FCPU\FCPU1", names = ["Temps","Fcpu1"])

data_attaque_fcpu2 = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\attaque1_nmap\FCPU\FCPU2", names = ["Temps","Fcpu2"])
...
data_attaque_tcpu1 = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\attaque1_nmap\TCPU\TCPU1", names = ["Temps","Tcpu1"])

data_attaque_tcpu2 = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\attaque1_nmap\TCPU\TCPU2", names = ["Temps","Tcpu2"])
...
data_attaque_delay = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\attaque1_nmap\DELAY", names = ["Temps","Delay"])
...
data_attaque_temperature = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\attaque1_nmap\TEMPERATURE", names = ["Temps","Temperature"])
...
data_attaque_luminosity = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\attaque1_nmap\LUMINOSITE", names = ["Temps","Luminosity"])


#temps

temps_debut_attaque = 1697022866
temps_fin_attaque = 1697023703

temps_debut_attaque13 = 1697022866000
temps_fin_attaque13 = 1697023703000
...
def classer(data_attaque1, data_sain1,temps_fin,temps_debut):
    ...
    labell_temps(data_attaque1,temps_fin,temps_debut,"nmap")
...
#registre trans
data_test_trans = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\test1_nmap\registre_transmissions.csv",delimiter = ';', names = ["Temps","Ip_src", "Ip_dest","Port_src","Port_dest","sup1","sup2","protocole"]) #delimiter seulement pour registre_transmissions
...
data_test_cpuusage = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\test1_nmap\cpu_stats.csv", names = ["Temps","Temperature", "Frequency", "Cpu_usage", "Cpu_memory"])


#fcpu

data_test_fcpu1 = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\test1_nmap\FCPU\FCPU1", names = ["Temps","Fcpu1"])

data_test_fcpu2 = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\test1_nmap\FCPU\FCPU2", names = ["Temps","Fcpu2"])


#tcpu

data_test_tcpu1 = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\test1_nmap\TCPU\TCPU1", names = ["Temps","Tcpu1"])

data_test_tcpu2 = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\test1_nmap\TCPU\TCPU2", names = ["Temps","Tcpu2"])


#delay

data_test_delay = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\test1_nmap\DELAY", names = ["Temps","Delay"])


#Temperature

data_test_temperature = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\test1_nmap\TEMPERATURE", names = ["Temps","Temperature"])


#Luminosity

data_test_luminosity = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\test1_nmap\LUMINOSITE", names = ["Temps","Luminosity"])

#TEMPS
temps_debut_test = 1697023841
temps_fin_test= 1697024022

temps_debut_test13 = 1697023841000
temps_fin_test13 = 1697024022000
...
def classer2(datatest,temps_fin,temps_debut):
    ...
    labell_temps(datatest,temps_fin,temps_debut,"nmap")
...
##
data_sain_test_cpuusage = data_test_cpuusage[data_test_cpuusage["Classe"] == "normal"]

##

test2 = pd.read_csv(r"C:\Users\Administrator\Documents\EN ENSEIGNE\PFE\RPI\TCPU2", names = ["Temps","Tcpu2"])
test2["Classe"] = "normal"
test2 = test2.drop("Temps", axis = 1)

##
test(test2,datatrain_tcpu2)
