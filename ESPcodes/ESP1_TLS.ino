...
// déclaration des topic mqtt à publier et s'abonner
...
// Declaration des clients Wi-Fivia TLS
...
void setup() {
  ...
  while (!client.connected()) {
    ...
    //verifyFingerprint();
    if (client.connect("ESP32Client_1")) {  //PAS SUR DE CA
